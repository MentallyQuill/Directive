...
function cohesionTask({ id, title, level, primaryFamily, anchor, situation, objective, whyItMatters, operationalEffect, next, crew = null }) {
  return {
    id, authored: id.startsWith('cohesion-authored.'), title, level, primaryFamily,
