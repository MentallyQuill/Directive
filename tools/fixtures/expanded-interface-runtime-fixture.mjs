...
const cohesionTasks = [
  ...
  cohesionTask({ id: 'cohesion-issue.missed-watch', title: 'The Missed Watch', level: 1, primaryFamily: 'personnel', anchor: 'crew', situation: 'A crewmember missed an important watch and forced improvised coverage.', objective: 'Establish the cause and restore reliable coverage.', whyItMatters: 'Reliable coverage protects a future taxed scene from delay or an unavailable specialist.', operationalEffect: 'Operations carries fragile watch coverage.', next: 'Speak privately with the crewmember', crew: { id: 'cohesion-crew.ari', name: 'Ari Chen', rank: 'Petty Officer', department: 'operations' } }),
  cohesionTask({ id: 'cohesion-issue.handoff', title: 'The Handoff Gap', level: 1, primaryFamily: 'coordination', anchor: 'central', situation: 'Two teams use the same readiness term differently.', objective: 'Establish one shared meaning and a reliable check-back.', whyItMatters: 'Later operational information reaches you faster and with less ambiguity.', operationalEffect: 'Routine handoffs require repeated confirmation.', next: 'Compare both handoff formulations' }),
  cohesionTask({ id: 'cohesion-issue.missing-pet', title: 'The Missing Pet', level: 1, primaryFamily: 'shipboardLife', anchor: 'crew', situation: 'An approved pet escaped into a shared shipboard area.', objective: 'Organize a proportionate search and safe recovery.', whyItMatters: 'You get a personal, low-stakes way to show the crew what kind of commander you are.', operationalEffect: 'A localized search diverts crew attention.', next: 'Bound the search area', crew: { id: 'cohesion-crew.bela', name: 'Bela Okafor', rank: 'Ensign', department: 'science' } }),
];
