...
const checks = [
  ...
  'test-architecture-redesign-contracts.mjs',
  'test-generation-timing-proof-policy.mjs',
  'test-external-prompt-environment.mjs',
  'test-sillytavern-external-context-observer.mjs',
  'test-external-context-fixture-prep.mjs',
  ...
  'test-sillytavern-external-context-readiness-preflight.mjs',
  'test-continuity-matrix-five-user-soak-coordinator.mjs',
  'test-continuity-matrix-full-certification-preflight.mjs',
  'test-architecture-redesign-release-bundle-preflight.mjs',
  'test-story-quality-review-preflight.mjs',
  'test-state-delta-gateway.mjs',
  'test-source-reconciliation-engine-synthetic.mjs',
  ...
  'test-sillytavern-message-mutation-actuation-preflight.mjs',
  'test-sillytavern-message-mutation-actuation-live-runner.mjs',
  ...
  'test-turn-commit-coordinator-core-mechanics.mjs',
  ...
  'test-repair-runtime-synthetic.mjs',
