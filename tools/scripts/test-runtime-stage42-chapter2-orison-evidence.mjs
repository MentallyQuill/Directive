...
assert.equal(flagValue(committed, 'chapter-2.calibration-evidence-status'), 'breckenridge-mismatch-demonstrated');
...
assert.equal(actorPosture(committed, 'uss-breckenridge')?.posture, 'alibi-supported-by-calibration');
...
for (const actorId of ['uss-breckenridge', 'director-nia-kessler', 'marshal-holt']) {
