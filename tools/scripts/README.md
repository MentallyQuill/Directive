...
`test-live-soak-prep.mjs` verifies the soak prep scaffolding without a live host: helper normalization, artifact directory creation, JSONL writing, schema constants, phase count, the 52-turn script, multi-campaign matrix, parallel-user setup hook, and the End Conditions terminal scenario contract.
