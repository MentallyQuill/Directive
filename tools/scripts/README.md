...
`test-live-soak-prep.mjs` verifies the soak prep scaffolding without a live host: helper normalization, artifact directory creation, JSONL writing, schema constants, phase count, and the 52-turn script.
