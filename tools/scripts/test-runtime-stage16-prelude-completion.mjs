...
assert.equal(finalCommit.campaignState.mission.activePhaseId, 'arrival-at-reach');
assert.equal(finalCommit.campaignState.mission.phase, 'arrival-at-reach');
assert.deepEqual(finalCommit.campaignState.mission.availableDecisionPointIds, []);
...
assert.equal(finalCommit.campaignState.mission.transitionStatus, 'chapter-1-queued');
