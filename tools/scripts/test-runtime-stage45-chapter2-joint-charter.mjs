...
assert.equal(actorPosture(committed, 'uss-breckinridge')?.posture, 'open-orders-authorized');
...
for (const actorId of ['director-nia-kessler', 'marshal-holt', 'uss-breckinridge', 'mara-whitaker']) {
