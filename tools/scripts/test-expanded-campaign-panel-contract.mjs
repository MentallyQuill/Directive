...
for (const action of ['openCampaignChat', 'saveGame', 'loadCheckpoint', 'deleteSave']) {
...
assert.doesNotMatch(panel, /actions\?\.selectCampaign|actions\.selectCampaign/, 'Campaign row selection remains presentation-only');
