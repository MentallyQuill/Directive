...
requireEqual(summary.campaign.eraLabel, '2376, after the Dominion War and while Voyager remains in the Delta Quadrant', 'summary campaign.eraLabel');
requireEqual(summary.campaign.structure.expectedLength, '35 to 60 substantial text-roleplay sessions', 'summary campaign.structure.expectedLength');
