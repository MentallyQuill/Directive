...
assert.equal(actorPosture(committed, 'uss-breckinridge')?.posture, 'testimony-preserved-through-care');
...
for (const actorId of ['aegis-two', 'director-nia-kessler', 'uss-breckinridge']) {
