...
assert.match(resizeHandleCss, /\bleft:\s*-1px;/, 'drawer resize handle should be on the bottom-left corner');
assert.match(resizeHandleCss, /\bbottom:\s*-1px;/, 'drawer resize handle should be on the bottom-left corner');
