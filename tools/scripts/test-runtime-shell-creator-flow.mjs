...
assert.equal(settledRuntimeSettingsPayload.payload.campaignState.settings.maxTurnSaveHistory, 8, 'Settle Active State checkpoint must capture runtime-current history setting.');
