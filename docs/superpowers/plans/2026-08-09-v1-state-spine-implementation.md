...
- [ ] **Step 1: Write failing Story Settlement contract tests**
...
- [ ] **Step 2: Run the Story Settlement test and verify RED**
...
- [ ] **Step 3: Implement Story Settlement constants, factory, and structural validator**
...
- [ ] **Step 4: Add the Story Settlement JSON schema**
...
- [ ] **Step 5: Run the Story Settlement test and verify GREEN**

Run: `node tools/scripts/test-v1-story-settlement-contracts.mjs`

Expected: `V1 Story Settlement contract tests passed.`

- [ ] **Step 6: Write failing mission-definition contract tests**
...
- [ ] **Step 7: Run the mission-definition test and verify RED**
...
- [ ] **Step 8: Implement mission constants, definition index, and validator**
...
- [ ] **Step 9: Add the V1 mission JSON schema**
...
- [ ] **Step 10: Register and run both tests**
...
- [ ] **Step 3: Implement the closed predicate vocabulary**
...
- [ ] **Step 4: Bind definition validation to predicate validation**
...
- [ ] **Step 5: Run and register the predicate test**
...
- [ ] **Step 4: Add explicit rejection codes**
...
- [ ] **Step 5: Run and register the evidence test**
...
- Create: `tests/fixtures/mission/v1-hesperus-reference.fixture.json`
- Modify: `tools/scripts/run-alpha-gate.mjs`
...
- [ ] **Step 3: Implement initial mission state**
...
- [ ] **Step 4: Implement the reduction order**
...
- [ ] **Step 6: Implement authorized transition packets**
...
- [ ] **Step 7: Run and register the reducer test**
...
- [ ] **Step 3: Implement active episode operations**
...
- [ ] **Step 4: Implement sealing and receipts**
...
- [ ] **Step 5: Implement Focus and invalidation**
...
- [ ] **Step 6: Run and register the lifecycle test**
...
- [ ] **Step 3: Add target state domains safely**
...
- [ ] **Step 4: Implement shadow spine orchestration**
...
- [ ] **Step 5: Implement stale-result and invalidation behavior**
...
- [ ] **Step 6: Run and register the integration test**
...
- [ ] **Step 1: Run all V1 targeted tests**
...
- [ ] **Step 2: Run focused legacy regression tests**
...
- [ ] **Step 3: Run the full alpha gate and classify baseline failures**
...
- [ ] **Step 4: Challenge the implementation against the approved architecture**
...
- [ ] **Step 5: Write and index the implementation report**
