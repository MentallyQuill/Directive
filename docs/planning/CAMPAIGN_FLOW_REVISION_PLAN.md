...
Redesign the Campaign route around a clear user flow:
...
- No Campaign UI text uses **Continue Campaign**.
- **Resume Draft** is replaced with **Continue Character Setup** in player-facing Campaign UI.
