...
| `docs-directive-glass-harbor-crew` | `docs/campaigns/GLASS_HARBOR_DROWNED_CONSTELLATION.md:100` | fixture | `assets/documentation/renders/docs-directive-glass-harbor-crew.png` | Glass Harbor Crew roster showing the authored senior-staff portraits. |
