...
- [Architecture Redesign Implementation Plan](planning/ARCHITECTURE_REDESIGN_IMPLEMENTATION_PLAN.md): staged execution plan for implementing the redesign through Frame, CORE, SRE, REPAIR, FORGE, LENS, v2 storage, scale gates, worker-agent coordination, and live proof.
