...
- [Continuity Projection Matrix](design/CONTINUITY_PROJECTION_MATRIX.md): Saga-informed design for source-backed, relevance-aware, depth-layered continuity prompt projection, generated-prose quarantine, audits, and contradiction guards.
