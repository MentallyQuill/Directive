...
- [V1 Episode Repair and Projection Readiness](development/V1_EPISODE_REPAIR_AND_PROJECTION_READINESS.md): certified semantic-boundary, sealed-supersession, anti-spam aggregate projection, source-rebuild, robustness, and residual-cutover boundary for the Ashes Prelude V1 shadow.
- [V1 Working Capsule and Soft-Boundary Readiness](development/V1_WORKING_CAPSULE_AND_SOFT_BOUNDARY_READINESS.md): certified bounded active memory, strict Utility proposals, transactional continue/seal behavior, anti-spam guarantees, failure containment, and residual-cutover boundary for the Ashes Prelude V1 shadow.
- [V1 Duty Report Delivery Readiness](development/V1_DUTY_REPORT_DELIVERY_READINESS.md): certified non-UI report preparation, selected-swipe custody, accepted-evidence authority, source reconstruction, anti-spam boundaries, and explicit visible-integration stop.
- [V1 Mission Transition Readiness](development/V1_MISSION_TRANSITION_READINESS.md): certified deterministic journey activation, durable pending targets, historic closure rollback, player-safe narration preparation, anti-spam boundaries, and explicit content/UI/live-certification limits.
- [Ashes V1 Empty Convoy Readiness](development/ASHES_V1_EMPTY_CONVOY_READINESS.md): certified Chapter 1 mission distillation, fair crew-led discovery, causal Duty Reports, non-linear mixed outcomes, real Prelude activation, source custody, and explicit narrator/UI/live limits.
- [Ashes V1 False Colors Readiness](development/ASHES_V1_FALSE_COLORS_READINESS.md): certified Chapter 2 mission distillation, spoiler-safe independent verification, coercion-free medical care, bounded security access, mixed outcomes, real Chapter 1 activation, source custody, and explicit narrator/UI/live limits.
- [Ashes V1 Open Orders I Readiness](development/ASHES_V1_OPEN_ORDERS_1_READINESS.md): certified V1-only interval identity, optional assignment load, player-owned engagement and conclusion, aggregate delegated assessment, causal source repair, real False Colors activation, and explicit narrator/UI/asset/live limits.
- [Ashes V1 Dead Letters Readiness](development/ASHES_V1_DEAD_LETTERS_READINESS.md): certified spoiler-safe Chapter 3 distillation, direct and alternate clue routes, no-fault loss, separate physical/human custody, aggregate report authority, real Open Orders activation, source recovery, and explicit scheduler/narrator/UI/live limits.
- [Ashes V1 The Colony That Stayed Readiness](development/ASHES_V1_COLONY_THAT_STAYED_READINESS.md): certified spoiler-safe Chapter 4 distillation, non-linear direct and alternate inquiry, neutral jurisdiction choices, fair no-fault consequences, aggregate report authority, real Dead Letters activation, source recovery, and explicit scheduler/narrator/UI/live limits.
- [Ashes V1 Old Lessons Readiness](development/ASHES_V1_OLD_LESSONS_READINESS.md): certified spoiler-safe Chapter 5 tactical distillation, non-linear multi-front outcomes, fair target loss, revisable Bronn posture, aggregate report authority, real Colony activation, source recovery, and explicit interval/narrator/UI/live limits.
- [Ashes V1 Open Orders II Readiness](development/ASHES_V1_OPEN_ORDERS_2_READINESS.md): certified V1-only recovery interval, optional assignment load, spoiler-safe assessment custody, credential-gated Chapter 6 setup, collision-safe journey reconstruction, real Old Lessons activation, and explicit narrator/UI/legacy/live limits.
- [Ashes V1 Chapter 6 Readiness](development/ASHES_V1_CHAPTER_6_READINESS.md): certified spoiler-safe Farwatch distillation, alternate truth routes, fair pre-knowledge evidence loss, aggregate report custody, real Open Orders II activation, source recovery, and explicit Chapter 7/narrator/UI/live limits.
- [Ashes V1 Chapter 7 Readiness](development/ASHES_V1_CHAPTER_7_READINESS.md): certified spoiler-safe constitutional-crisis distillation, alternate political and technical truth routes, freeform settlements, authoritative deadline custody, fair pre-knowledge conflict, post-arrival play, real Chapter 6 activation, and explicit Open Orders III/narrator/UI/live limits.
- [Ashes V1 Open Orders III Readiness](development/ASHES_V1_OPEN_ORDERS_3_READINESS.md): certified V1-only preparation interval, reversible optional assignment load, agency-safe consent handling, bounded asset results, aggregate distributed readiness, no synthetic clock, real Chapter 7 activation, and explicit Chapter 8/narrator/UI/live limits.
- [Ashes V1 Chapter 8 Readiness](development/ASHES_V1_CHAPTER_8_READINESS.md): certified non-UI five-front finale, freeform executable command plan, aggregate one-shot reports, partial and costly success, bounded historical capabilities, exact epilogue activation, source reconstruction, and explicit UI/narrator/live limits.
- [Ashes V1 Epilogue and Conclusion Readiness](development/ASHES_V1_EPILOGUE_AND_CONCLUSION_READINESS.md): certified thirteenth mission, non-linear seven-axis settlement, spoiler-safe aggregate reports, exact authored-completion receipt, idempotency, historic invalidation, and remaining player-facing/live boundaries.
...
- [Architecture Redesign Proposal](planning/ARCHITECTURE_REDESIGN_PROPOSAL.md): forward-only transaction, storage, Director, CPM, Handshake, sidecar, recovery, external-context compatibility, and 5000-message/under-60-second latency redesign proposal.
- [Architecture Redesign Implementation Plan](planning/ARCHITECTURE_REDESIGN_IMPLEMENTATION_PLAN.md): staged execution plan for implementing the redesign through Frame, CORE, SRE, REPAIR, FORGE, LENS, v2 storage, external-context coexistence, scale gates, worker-agent coordination, and live proof.
...
- [Command Authority Model Feature Patch](planning/COMMAND_AUTHORITY_MODEL_FEATURE_PATCH.md): campaign-wide design and implementation plan for separating player agency, command recipient, delegation, conn, and succession authority in prompts and runtime state.
