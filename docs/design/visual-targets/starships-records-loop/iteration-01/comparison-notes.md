...
- Phone screenshot: [starships-records-before-phone.png](starships-records-before-phone.png)
- Desktop screenshot: [starships-records-before-desktop.png](starships-records-before-desktop.png)
- Layout evidence: [starships-records-before-layout.json](starships-records-before-layout.json)
...
- Phone screenshot: [starships-records-after-phone.png](starships-records-after-phone.png)
- Desktop screenshot: [starships-records-after-desktop.png](starships-records-after-desktop.png)
- Layout evidence: [starships-records-after-layout.json](starships-records-after-layout.json)

Implementation result:

- Starships records now render as `directive-starship-records-console` instead of a generic metadata stack.
