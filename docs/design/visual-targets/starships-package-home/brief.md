# Starships Package Home Brief

## Visual Target Unit

Starships package/home surface plus the shared Directive shell.
...
- Route navigation for Starships, Mission, Crew, Ship, Log, and Settings.
- Close Directive.
...
- Starships content must fit inside the existing scroll pane.
