...
- A shared command-spine runtime shell with a phone-width bottom-navigation fallback.
...
- Data-only Theme Pack and Icon Pack foundations plus package image fallback behavior for the runtime UI.
