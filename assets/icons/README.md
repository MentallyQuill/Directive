...
- `comm-badge.svg`: player-character and crew-roster fallback badge rendered as a CSS mask so the surrounding LCARS surface owns color.
- `delete-campaign.svg`: destructive campaign-action glyph rendered as a CSS mask so Directive owns its danger and interaction colors.
