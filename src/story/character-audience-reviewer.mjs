...
export function createCharacterAudienceReviewer({ generation } = {}) {
 return { async review({prepared,budget,reservation,signal,isCurrent,analysisLimits={}}={}) {
  ...
  const payload={manifest:prepared.manifest,evidence:prepared.evidence,manifestDigest:prepared.manifestDigest,evidenceDigest:prepared.evidenceDigest,identityDigest:prepared.identityDigest};
