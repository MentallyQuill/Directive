...
function buildCommandBearingDelta(awards) {
  return {
...
function emptyCommandBearingDelta() {
  return {
    earnedRecordsAdd: [],
...
export function buildStateDelta({ graphIndex, campaignState, outcomePacket, intentParse, authorityCapabilityCheck, phaseAdvance }) {
  if (intentParse.primaryIntent === 'terminal-catastrophic-command') {
    return {
      ...
      clocks: [],
      commandBearing: emptyCommandBearingDelta(),
      relationships: {
        descriptiveChanges: [],
        rawValuesHidden: true
      },
  ...
  if (intentParse.primaryIntent === 'set-initial-convoy-posture') {
    ...
    return {
      ...
      commandBearing: buildCommandBearingDelta(outcomePacket.commandDecisionAwards || []),
      pressureLedger: buildPressureLedgerDeltaForTurn({ campaignState, outcomePacket, intentParse }),
      relationships: {
        affectedCrewIds: intentParse.targetIds || [],
        descriptiveChanges: [],
