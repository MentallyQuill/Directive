...
const MATRIX = Object.freeze({
  ...
  missionDirectorStoryPositioner: {
    ...
    trigger: 'Foreground Mission Director turn needs source-bound story position before any outcome decision.',
    blocking: true,
    mayProposeState: false,
    mayInjectPrompt: false,
    allowedRoots: EMPTY,
